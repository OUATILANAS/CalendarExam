...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.demo.CalendarApplicationTests", () -> new AotSpringBootConfigContextLoader(CalendarApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.demo.CalendarApplicationTests", CalendarApplicationTestsContextInitializer.class);
    return entries;
  }
}
